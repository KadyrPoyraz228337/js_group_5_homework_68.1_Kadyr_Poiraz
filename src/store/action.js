...
export const addCounter = (amount) => dispatch => {
    dispatch({type:ADD,amount});
    dispatch(saveCounter());
};
export const subtractCounter = (amount) => dispatch => {
...
export const saveCounter = () => dispatch => {
    axiosOrders.put('counter.json', dispatch(store.getState).counter )
};
